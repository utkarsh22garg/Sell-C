...
//abc//cghsx
    ...
    private class BackgroundTask_profile extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            String user_url="https://sell-c.000webhostapp.com/getProfile.php";
            ...
            if(res!=null)
            {
                ...
                else
                {
                    ...
                    try {
                        ...
                        String im1="https://sell-c.000webhostapp.com/"+url;
                        SharedPreferences sharedpreferences = getApplicationContext().getSharedPreferences("Shared", MODE_PRIVATE);
    ...
    public class BackgroundTask1 extends AsyncTask<String,Void,Void> {
        ...
        protected Void doInBackground(String... params) {
          ...
          //  String id=params[0];
            //ID=id;
              String user_url="https://sell-c.000webhostapp.com/getData.php";
